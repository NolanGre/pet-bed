...
public enum CallbackId {
    ...
    ADOPTION_MY_RESPONSE_DETAIL_FINAL_CONFIRM(6312, "🏁 Фінальне підтвердження", ADOPTION_MY_RESPONSE_DETAIL),
    ADOPTION_MY_RESPONSE_FINAL_CONFIRM(63121, "✅ Підтвердити", ADOPTION_MY_RESPONSE_DETAIL_FINAL_CONFIRM),

    ADOPTION_MY_POSTS(64, "📋 Мої оголошення", ADOPTION),
    ADOPTION_POST_DETAIL(641, "", ADOPTION_MY_POSTS),      // Shows as paginated list of responses for a post
    ADOPTION_POST_RESPONSE_DETAIL(6411, "", ADOPTION_POST_DETAIL),     // Shows single response details with actions
    ADOPTION_POST_RESPONSE_TRY_CONFIRM(64111, "✅ Підтвердити", ADOPTION_POST_RESPONSE_DETAIL),
    ADOPTION_POST_RESPONSE_CONFIRM(641111, "✅ Підтвердити", ADOPTION_POST_RESPONSE_TRY_CONFIRM),
    ADOPTION_POST_RESPONSE_TRY_REJECT(64112, "❌ Відхилити", ADOPTION_POST_RESPONSE_DETAIL),
    ADOPTION_POST_RESPONSE_REJECT(641121, "❌ Відхилити", ADOPTION_POST_RESPONSE_TRY_REJECT),
    ADOPTION_POST_RESPONSE_TRY_RESTORE(64113, "🔄 Відновити", ADOPTION_POST_RESPONSE_DETAIL),
    ADOPTION_POST_RESPONSE_RESTORE(641131, "✅ Підтвердити", ADOPTION_POST_RESPONSE_TRY_RESTORE),
    ...
    FOSTERING_GET_PREV(722, "◀️ Минула", FOSTERING_GET),
    FOSTERING_SAVE_POST(724, "❤️ Зберегти", FOSTERING_GET),
    FOSTERING_UNSAVE_POST(725, "💔 Видалити", FOSTERING_GET),
    FOSTERING_RESPONSE_CREATE(726, "✉️ Відгукнутись", FOSTERING_GET),  // Start form for comment
    ...
    FOSTERING_MY_RESPONSE_DETAIL_FINAL_CONFIRM(7312, "🏁 Фінальне підтвердження", FOSTERING_MY_RESPONSE_DETAIL),
    FOSTERING_MY_RESPONSE_FINAL_CONFIRM(73121, "✅ Підтвердити", FOSTERING_MY_RESPONSE_DETAIL_FINAL_CONFIRM),
    ...
    FOSTERING_MY_SAVED(75, "❤️ Збережені", FOSTERING),
    FOSTERING_SAVED_DETAIL(751, "", FOSTERING_MY_SAVED),
