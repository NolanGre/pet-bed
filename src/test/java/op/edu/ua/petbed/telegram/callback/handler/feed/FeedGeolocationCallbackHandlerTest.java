...
class FeedGeolocationCallbackHandlerTest {
    ...
    @InjectMocks
    FeedGeolocationCallbackHandler underTest;
    ...
    class Handle {
        ...
        void handle_startsFormAndReturnsMessage() {
            ...
            given(context.callbackData()).willReturn(CallbackData.of(CallbackId.FEED_GEOLOCATION, null, 0));
            given(formService.startCreateForm(FormType.SET_GEOLOCATION, CallbackId.FEED, internalId, chatId)).willReturn(null);
            ...
            verify(formService).startCreateForm(FormType.SET_GEOLOCATION, CallbackId.FEED, internalId, chatId);
        }
    }
}