...
/**
 * Handler for FOSTERING_GET_NEXT callback - shows next fostering post.
...
@Slf4j
public class FosteringGetNextCallbackHandler implements CallbackHandler {
    ...
    public CallbackId getCallbackId() {
        return CallbackId.FOSTERING_GET_NEXT;
    }
